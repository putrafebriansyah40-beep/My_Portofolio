      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-10">
          ...
          <div className="flex flex-col items-center gap-4">
            <p className="text-[10px] uppercase tracking-[0.2em] text-purple-300/60 font-bold">Built With</p>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] text-purple-200/40 font-mono tracking-wider">
          <p>Designed & Developed by Febriansyah Putra &middot; {currentYear}</p>
          <p>Made with <span className="text-pink-500/70 animate-pulse">❤</span> in Padang, Indonesia</p>
        </div>
