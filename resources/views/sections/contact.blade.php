                ...
                <div class="glass-card p-8 h-full">
                    ...
                    <div class="space-y-6">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $phone ?? '6283195690357') }}" target="_blank" class="flex items-center gap-4 group cursor-pointer">
                            <div class="w-12 h-12 flex-shrink-0 rounded-full bg-primary-500/10 flex items-center justify-center text-primary-400 group-hover:bg-primary-500 group-hover:text-white transition-all duration-300">
