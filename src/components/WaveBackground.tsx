...
export default function WaveBackground() {
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute inset-0 bg-[#EBE6EF]"></div>
      {/* Canvas for Interactive 3D Wave */}
      <canvas ref={canvasRef} className="absolute inset-0 w-full h-full opacity-80 mix-blend-multiply"></canvas>
      {/* Gradient Overlay agar teks tetap terbaca dengan jelas */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#EBE6EF]/50 via-transparent to-transparent"></div>
    </div>
  );
}
